...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactMixin = __webpack_require__(214);
	...
	var _userProfile = __webpack_require__(219);
	...
	var _notes = __webpack_require__(221);
	...
	var Profile = (function (_React$Component) {
		...
		_createClass(Profile, [{
			...
			value: function componentDidMount() {
				this.ref = new _firebase2.default('https://blazing-torch-5198.firebaseio.com/');
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-md-4' },
						_react2.default.createElement(_userProfile2.default, { username: this.props.params.username,
							name: this.state.bio.name })
					),
					_react2.default.createElement(
						'div',
						{ className: 'col-md-4' },
						_react2.default.createElement(_repos2.default, { username: this.props.params.username,
	...
	(0, _reactMixin2.default)(Profile.prototype, _reactfire2.default);
